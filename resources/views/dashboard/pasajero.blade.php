...
<div class="container mt-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <div class="card text-white bg-success">
                <div class="card-body">
                    ...
                    <h3>{{ $stats['viajes_completados'] }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card text-white bg-primary">
                <div class="card-body">
                    <h6>Total Gastado</h6>
                    <h3>${{ number_format($stats['gastado_total'], 2) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card border-info mb-4 shadow">
        <div class="card-header bg-info text-white">
            <strong>🚖 Tienes un viaje activo</strong>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p><strong>Conductor:</strong> {{ $viajeActivo->conductor->usuario->nombre_completo ?? 'Esperando asignación...' }}</p>
                    <p><strong>Tarifa estimada:</strong> ${{ $viajeActivo->tarifa_estimada }}</p>
    ...
    <div class="card mb-4 shadow">
        <div class="card-header bg-primary text-white">
            <strong>🚕 Solicitar Nuevo Viaje</strong>
        </div>
        <div class="card-body text-center">
            <a href="{{ url('viaje/create') }}" class="btn btn-lg btn-primary">
                ➕ Nuevo Viaje
            </a>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-dark text-white">
            <strong>📋 Mi Historial de Viajes</strong>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="6" class="text-center text-muted py-3">Aún no tienes viajes</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
